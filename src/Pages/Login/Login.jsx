                ...
                <div>
                    ...
                    <div>
                        <div className="my-6 space-y-4">
                            <button onClick={handleLoginWithGoogle} onMouseEnter={()=> setTextColor(false)} onMouseLeave={()=>setTextColor(true)} aria-label="Login with Google" type="button" className={`border-[#431A20] flex items-center justify-center w-full p-4 space-x-4 border rounded-md focus:ring-2 focus:ring-offset-1 dark:border-gray-600 focus:dark:ring-violet-600`}>
                            ...
                            <button onClick={handleLoginWithGithub} onMouseEnter={()=> setTextColor2(false)} onMouseLeave={()=> setTextColor2(true)} aria-label="Login with GitHub" role="button" className={`border-[#431A20] flex items-center justify-center w-full p-4 space-x-4 border rounded-md focus:ring-2 focus:ring-offset-1 dark:border-gray-600 focus:dark:ring-violet-600`}>
